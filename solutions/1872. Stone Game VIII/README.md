...
Given an integer array `stones` of length `n` where `stones[i]` represents the value of the `ith` stone **from the
left**, return the **score difference** between Alice and Bob if they both play **optimally**.
