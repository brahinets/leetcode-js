...
describe('2073. Time Needed to Buy Tickets', (): void => {
    ...
    it('buys ticket going around queue twice', (): void => {
        expect(timeRequiredToBuy([2, 3, 2], 2))
            .toBe(6)
    })

    it('buys ticket going around queue multiple times', (): void => {
        expect(timeRequiredToBuy([5, 1, 1, 1], 0))
            .toBe(8)
    })

    it('buys ticket going around large queue multiple times', (): void => {
